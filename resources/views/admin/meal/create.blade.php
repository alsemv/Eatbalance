...
@section('content')
    <div class="card mb-3 meal">
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-4">
                    <form action="{{route('admin.meal.store')}}" enctype="multipart/form-data" method="POST">
                        <div class="form-group">
                            <label for="name" class="col-form-label">Название</label>
                            <input id="name" class="form-control {{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" value="{{ Request::old('name') }}">
                            @if ($errors->has('name'))
                        ...
                        <div class="form-group">
                            ...
                            <input id="calories" class="form-control {{ $errors->has('calories') ? ' is-invalid' : '' }}" name="calories" value="{{ Request::old('calories') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input id="weight" class="form-control {{ $errors->has('weight') ? ' is-invalid' : '' }}" name="weight" value="{{ Request::old('weight') }}">
